class ApiLink
    ...
    def self.get_data(beer)
        url = 'https://api.untappd.com/v4/search/beer?q=ale&limit=50&client_id=9DED174D29B0B92A010B93987C3A5EA7F138FF87&client_secret=B67ADF09F15D30AD3E14C9006B7C1FA49C0E52C1'
